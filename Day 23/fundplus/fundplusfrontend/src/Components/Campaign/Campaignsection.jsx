...
export const Campaignsection = () => {
  ...
  const handleDeleteCampaign = async (campaignid) => {
    console.log(campaignid);
    await Services.adminDeleteCampaign(campaignid)
      .then((res) => {
  ...
  const handleChange = async () => {
    await Services.getUser(localStorage.getItem("userid"))
      .then((res) => {
                ...
                {Campaigns?.map((campaigns, index) => (
                  <>
                    <div className="flex lg:flex-col xl:w-full  xl:pb-12 items-center  justify-between ">
                      ...
                      <div className="flex  lg:hidden  justify-end mr-2  items-center gap-16 text-darkteal">
                        <div>
                          <span>₹0</span>
                        </div>
