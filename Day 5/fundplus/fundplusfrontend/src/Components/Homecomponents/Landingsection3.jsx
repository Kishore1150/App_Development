    ...
    <main className="h-full bg-backgroundwhite w-full">
      <section className="m-24">
        <div className="xl:flex lg:flex lg:flex-col  justify-center gap-6  items-center  ">
          <div className="grid grid-cols-2  xl:w-[60em] gap-y-5 gap-x-8">
            <figure className="hover:duration-300  hover:opacity-80 max-w-[255px] max-h-[300px]">
              <img
            ...
            <figure className="hover:duration-300   hover:opacity-80 max-w-[255px] max-h-[300px] xl:relative xl:top-12">
              <img
                className="rounded-xl  object-cover  xl:w-[255px] xl:h-[300px] "
                src={person2}
                alt=""
            ...
            <figure className=" max-w-[255px] hover:duration-300  hover:opacity-80 max-h-[300px] xl:relative xl:top-[3em]">
              <img
                className="rounded-xl  object-cover  xl:w-[255px] xl:h-[300px] "
                src={person4}
                alt=""
