...
export const Landingsection1 = () => {
  return (
    <>
      <div class="box1-main bg-landingimage lg:bg-cover  w-full xl:bg-cover bg-no-repeat bg-center  lg:flex-col h-[700px]   lg:h-[500px]">
        <div className="grid place-content-center h-full  ">
          <div className="flex flex-col items-center gap-5">
            <p className="xl:text-6xl lg:text-5xl text-darkteal  font-productsansb font-extrabold">
              Your Home
            </p>
            <p className="xl:text-6xl lg:text-5xl text-darkteal font-productsansb font-extrabold">
              for Help
          ...
          <div className="flex justify-center mt-6 items-center gap-5">
            <button class="box1l-btn1 flex items-center  gap-3 font-bold font-productsansb xl:px-8 xl:py-4 lg:px-6 lg:py-4 xl:text-xl bg-white text-darkteal hover:bg-[#e6f6ef] hover:duration-700  hover:transition-all shadow-2xl rounded-full">
