    ...
    <>
      <main className="xl:h-[42rem]">
        <section className="flex lg:flex-col bg-backgroundwhite gap-5 items-end justify-center ">
          ...
          <form
            onSubmit={sendEmail}
            className="xl:w-[35rem] lg:p-5 bg-white xl:drop-shadow-xl dark:bg-darkgray text-black xl:p-8 rounded-3xl">
            <div className="flex flex-col gap-7">
              <h1 className="font-bold  text-center dark:text-white  mt-3  text-4xl">
                Send us message
              </h1>
